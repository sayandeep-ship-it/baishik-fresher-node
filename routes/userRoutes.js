...
const { authorizeUser, authenticateUserOr404 } = require('../middleware/roleMiddleware');
...
router.post('/me/loyalty-programs/scan', authenticateUserOr404, userController.scanLoyaltyQr);
